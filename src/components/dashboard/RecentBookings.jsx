    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        {bookings.map((booking) => (
          <div key={booking.id} className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition-colors border-b border-gray-100 last:border-b-0">
            ...
            <div className="flex flex-col items-end space-y-2">
              <button className="px-4 py-2 bg-white hover:bg-gray-50 border border-gray-300 rounded-xl text-sm font-medium text-gray-900 transition-colors">
                {booking.action}
              </button>
